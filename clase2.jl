...
# ╔═╡ 97c205fc-4011-11f1-8f48-4b00751d75c4
using MAT, LinearAlgebra, Plots


# ╔═╡ fe4a2d32-1707-457c-b93d-dbe65c2888af
begin
file = matopen("datos.mat")
datos = read(file, "datos_1")
end

# ╔═╡ cdfa3da1-45c3-4d8f-a387-675001dcd0e0
function d_theta(datos,theta)
	x = datos[:,1]
	y = datos[:,2]
	a,b,r = theta
	return sqrt.((x.-a).^2+(y.-b).^2).-r
end

# ╔═╡ a828115d-5e15-44ea-9f0a-46903777c821
function F(datos,theta)
	d = d_theta(datos,theta)
	return sum(d.^2)
end

# ╔═╡ f4c3ed08-1cb9-41f3-89a3-a58feb65b9c1
function Jd(datos,theta)
	x = datos[:,1]
	y = datos[:,2]
	a,b,r = theta
	grad_d1 = (a.-x)/sqrt.((x.-a).^2+(y.-b).^2) 
	grad_d2 = (b.-y)/sqrt.((x.-a).^2+(y.-b).^2) 
	grad_r  = -ones(length(x))
	return [grad_d1 grad_d2 grad_r]	
end

# ╔═╡ 8a41a12c-6432-47c1-b57c-17e966146c42
function ajuste_geom(datos,theta_0,tol1,tol2)
	theta = theta_0
	Jd = Jd(datos,theta)
	d  = d_theta(datos,theta) 
	h  = Jd\-d
	theta = theta + h
	while norm(h)>tol1 && norm(d)>tol2 
		Jd = Jd(datos,theta)
		d  = d_theta(datos,theta) 
		h  = Jd\-d
		theta = theta + h
...
manifest_format = "2.0"
project_hash = "38f9fbcb67b2cb8165bb4a3e0e7a7f1271557644"
...
git-tree-sha1 = "9592d5ba4438a1b2b6990fa383acedb5401c4e90"
uuid = "23992714-dd62-5051-b70f-ba57cb901cac"
version = "0.12.0"

[[deps.MPIABI_jll]]
deps = ["Artifacts", "Hwloc_jll", "JLLWrappers", "LazyArtifacts", "Libdl", "MPIPreferences", "TOML"]
git-tree-sha1 = "8d684b5918769c4f9423e0ee3bbdefdab82709e8"
...
git-tree-sha1 = "c5ce26ac1d6d17f35e965d82a4d13566330e368c"
